...
1. Let $I = \langle y - x^2, z - x^3 \rangle \subseteq k[x, y, z]$. 
...
* The fact that the variety of a monomial ideal is a finite union of coordinate subspaces. 
* Definition of dimension for the variety of a monomial ideal. 
...
Possible reading: Either {{ clo15 | replace: "x", "Sections 3.1--2 through Theorem 3.2.7" }} or {{ ful08 | replace: "x", "Sections 1.7--10" }}, you can choose!
