...
1. Suppose $I$ is a homogeneous ideal. Prove that the reduced Gr\"obner basis of $I$ with respect to any monomial order consists of homogeneous polynomials. Hint: Carefully analyze what happens when one works through Buchberger's algorithm starting from a homogeneous generating list. 
