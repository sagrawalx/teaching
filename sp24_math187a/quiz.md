...
* Resources: In general, the only resource you are allowed is one two-sided handwritten sheet of notes on quizzes. No calculators or computers, so you should be prepared to have to do a small amount of mental arithmetic. 
